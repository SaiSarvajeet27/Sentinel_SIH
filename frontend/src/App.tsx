        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/" element={<ProtectedLayout />}>
              ...
              <Route path="live-demo" element={<LiveThreatSimulationPage />} />
              <Route path="simulation" element={<LiveThreatSimulationPage />} />
              <Route path="simulator" element={<LiveThreatSimulationPage />} />
